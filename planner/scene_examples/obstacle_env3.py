...
wall_obstacles_dicts = [
    # Two internal walls
    {
        'type': 'box', 
         'geometry': {
             'position': [int_walls_length/3.0, 4, 5], 'width': int_walls_length, 'height': 10, 'length': 0.1
        },
        'high': {
            'position' : [int_walls_length/3.0, 4, 0.4],
            'width': int_walls_length,
            'height': 0.8,
            'length': 0.1,
        },
        'low': {
    ...
    },
    {
        'type': 'box', 
         'geometry': {
             'position': [-7, 2, 4], 'width': 0.1, 'height': 8, 'length': int_walls_length/2.0
        },
        'high': {
            'position' : [-int_walls_length/3.0, -4, 0.4],
            'width': int_walls_length,
    ...
    },
    {
        'type': 'box', 
         'geometry': {
             'position': [7, -2, 6], 'width': 0.1, 'height': 8, 'length': int_walls_length/2.0
        },
        'high': {
            'position' : [-int_walls_length/3.0, -4, 0.4],
            'width': int_walls_length,
...
obstacles_env3 = [BoxObstacle(name=f"wall_{i}", content_dict=obst_dict) for i, obst_dict in enumerate(wall_obstacles_dicts)]
